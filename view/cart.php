                    ...
                    <div class="cart__products">
                        ...
                        <div class="cart__products__wrapper">
                            ...
                            <div class="cart__products__count">
                                ...
                                <div class="cart__products__count__num"><input type="number" data-id-product="<?= $product['id_product']?>" disabled value="<?= $product['count_product']?>" max="99" min="1"></div>
                                <div class="cart__products__count__plus" data-id-product="<?= $product['id_product']?>">+</div>
                            </div>
                            <div class="cart__products__price">
                                <span class="cart__products__price__text" data-id-product="<?= $product['id_product']?>"><?= $product['count_product'] * $product['price_product']?></span>&#8381;
                            </div>
