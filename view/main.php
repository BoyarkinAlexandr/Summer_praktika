        ...
        <div class="cart__wrapper">
            ...
            <div class="cart__products__container">
                <div class="cart__products">
                    <div class="cart__products__favourites">
                    ...
                    <div class="cart__products__wrapper">
                        ...
                        <div class="cart__products__count">
                            ...
                            <div class="cart__products__count__num"><input type="number" value="5" max="99" min="1"></div>
                            <div class="cart__products__count__plus">+</div>
                        </div>
                        <div class="cart__products__price">
                            <span class="cart__products__price__text">1200</span>&#8381;
                        </div>
                    </div>
                </div>
                <div class="cart__products">
